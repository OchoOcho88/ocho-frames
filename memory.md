...
- **Blocker being cleared (S032): Hugo is re-shooting all three bands.** Everything shot so far is the heavy. Rather than only adding light and medium, he is re-shooting all three in one sitting with the light and white balance locked, because three caramels shot on different days will not sit together in a colourway strip. Shot list at `clients/sportif/products/band-photo-shot-list.md`. Unblocks the colourway strips (his own ref 06 pick), the range card and the wholesale line sheet (Q-015).

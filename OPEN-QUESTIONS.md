...
- [ ] [Q-015] 2026-08-20 | Sportif | Photograph the LIGHT and MEDIUM bands, and RE-SHOOT the heavy alongside them in the same sitting so the three caramels match. Hugo has good lighting and is doing it. Shot list at `clients/sportif/products/band-photo-shot-list.md` (6 frames per band, plus a family shot and a white-paper colour reference, exposure and white balance locked). Unblocks the colourway strips (his ref 06 pick), the range card and the wholesale line sheet. (opened S032)

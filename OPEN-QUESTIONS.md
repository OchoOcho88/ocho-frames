...
- [ ] [Q-018] 2026-08-21 | Sportif | Four frames to complete the band set: the LIGHT band's two inside-grip shots (missing from shoot 4), plus label close-ups if convenient. Nothing is blocked by this, the front-folded frames carry the label. (opened S032)

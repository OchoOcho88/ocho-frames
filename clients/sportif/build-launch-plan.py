...
<style>
 .lbl{font-family:'Glacial Indifference',sans-serif;fill:#C6926E;font-size:12px;font-weight:600;letter-spacing:2px;}
 .pill{font-family:'Glacial Indifference',sans-serif;fill:#4A433C;font-size:13.5px;font-weight:500;}
 .cap{font-family:'Glacial Indifference',sans-serif;fill:#C6926E;font-size:12px;font-style:italic;}
 .shopA{font-family:'Glacial Indifference',sans-serif;fill:#F6EEE5;font-size:14px;font-weight:600;letter-spacing:.5px;}
 .shopB{font-family:'Glacial Indifference',sans-serif;fill:#F6EEE5;font-size:12px;}
 .shopC{font-family:'Glacial Indifference',sans-serif;fill:#F6EEE5;font-size:10.5px;}
 .out{font-family:'Glacial Indifference',sans-serif;fill:#2D1814;font-size:13.5px;font-weight:600;}
 .sub{font-family:'Glacial Indifference',sans-serif;fill:#8a7a6c;font-size:10px;}
 .loop{font-family:'Glacial Indifference',sans-serif;fill:#833827;font-size:10px;font-weight:500;}
</style>
...
<g>
 <rect x="44"  y="43" width="118" height="26" rx="13" fill="#FFBE9F"/><text x="103" y="60" text-anchor="middle" class="pill">Instagram</text>
 <rect x="174" y="43" width="118" height="26" rx="13" fill="#FFBE9F"/><text x="233" y="60" text-anchor="middle" class="pill">TikTok</text>
 <rect x="304" y="43" width="118" height="26" rx="13" fill="#FFBE9F"/><text x="363" y="60" text-anchor="middle" class="pill">Lucy</text>
 <rect x="434" y="43" width="118" height="26" rx="13" fill="#FFBE9F"/><text x="493" y="60" text-anchor="middle" class="pill">Ambassadors</text>
 <rect x="564" y="43" width="118" height="26" rx="13" fill="#FFBE9F"/><text x="623" y="60" text-anchor="middle" class="pill">A little paid</text>
</g>
...
<text x="372" y="222" class="cap">it becomes</text>
<line x1="360" y1="206" x2="360" y2="220" stroke="#C6926E" stroke-width="2"/>
<polygon points="353,219 367,219 360,229" fill="#C6926E"/>
...
<path d="M598,250 C690,218 700,125 676,84" fill="none" stroke="#833827" stroke-width="2"/>
<polygon points="667,86 684,84 673,72" fill="#833827"/>
...
<rect x="170" y="308" width="380" height="34" rx="17" fill="#FFBE9F"/>
...
.sec{{ font-family:'Glacial Indifference',sans-serif; font-weight:600; font-size:15pt; color:var(--choc); margin-bottom:3.5mm; letter-spacing:0; text-transform:none; }}
.idea{{ font-style:italic; color:var(--caramel); font-size:11.6pt; margin-bottom:4mm; line-height:1.45; }}

#!/usr/bin/env python3
"""Email 02 social batch, v2. Lucy's revisions (2026-08-14).
...
OUT = ROOT / 'clients/sportif/email-02-social/created/v2'
...
MANUAL_PLACEMENT = {
    ('story', 'ballreach'):   (236, 295, 478, 560),   # Hugo, 2026-08-17 (marked twice, agreed)
    ('story', 'sidestretch'): (643, 601, 980, 903),   # Hugo, 2026-08-17, RIGHT side not left
